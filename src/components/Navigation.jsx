        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Button
              variant="ghost"
              onClick={onHomeClick}
              className="font-medium dark:text-[#b8336a]"
            >
              Home
            </Button>
            <Button
              ...
              className=" relative font-medium dark:text-[#b8336a]"
            >
              WatchList
              {watchlistCount > 0 && (
            ...
            >
              {darkMode ? (
                ...
                <span className=" font-medium dark:text-[#b8336a]">
                  Dark Mode
                </span>
              )}
            </Button>
            <Button
              ...
              className=" font-medium relative dark:text-[#b8336a]"
            >
              Profile
            </Button>
          </div>
